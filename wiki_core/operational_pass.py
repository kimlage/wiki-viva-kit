...
def _strings(language: str) -> dict[str, str]:
    strings = {
        "es": {
            "title": "Pasada operativa - fuentes, acciones y contextos",
            "purpose": "compilación transversal de fuentes, acciones, incertidumbres y próximos pasos",
            "updated": "Actualizado el: {date}.",
            "intro": "Compilación determinista para los contextos: {contexts}. Use esta página para condensar los próximos pasos en acciones, problemas, afirmaciones, decisiones y páginas de destino; no sustituye la lectura humana de las fuentes vivas.",
            "h_short_memory": "## Memoria de corto plazo",
            "short_intro": "Lea esto primero: estado diario compacto de los elementos que aún requieren revisión, decisión o acción. Las secciones completas de diagnóstico continúan abajo.",
            "short_review_now": "Revisar ahora",
            "short_actions": "Acciones principales",
            "short_decisions": "Decisiones pendientes",
            "short_recent": "Últimas actualizaciones",
            "short_no_review": "No hay elementos que requieran atención.",
            "short_no_actions": "No hay acciones pendientes priorizadas.",
            "short_no_decisions": "No hay decisiones pendientes.",
            "short_no_recent": "No hay actualizaciones registradas.",
            "all_contexts": "todos",
            "h_contexts": "## Resumen por contexto",
            "th_contexts": "| Contexto | Hub | Vitalidad | Fuentes | Fuentes que requieren atención | Acciones | Acciones que requieren atención | Afirmaciones / decisiones | Próximos pasos |",
            "h_outputs": "## Matriz de resultados de consolidación",
            "th_outputs": "| Contexto | Acciones | Problemas | Afirmaciones | Decisiones | Contextos densos | Fuentes no ingeridas | Señal |",
            "h_sources": "## Fuentes por estado",
            "th_sources": "| Fuente | Contexto | Ingestión | Última actualización | Próxima revisión | Estado | Acciones vinculadas |",
            "h_actions": "## Acciones compiladas",
            "th_actions": "| Acción | Contexto | Estado | Actualización | Fuentes | Señal |",
            "h_decisions": "## Decisiones pendientes",
            "th_decisions": "| Decisión | Contexto | Estado | Actualización | Acciones vinculadas | Señal |",
            "h_decision_blocks": "## Acciones bloqueadas por decisiones pendientes",
            "th_decision_blocks": "| Decisión | Acción | Contexto de la acción | Estado de la decisión | Estado de la acción |",
            "h_attention": "## Problemas e incertidumbres",
            "th_attention": "| Contexto | Tipo | Página | Motivo |",
            "h_resume": "## Enlaces para retomar",
            "root": "Índice",
            "operations": "Operaciones",
            "source_registry": "Registro de fuentes",
            "pending_actions": "Acciones pendientes",
            "generated_by": "Generado por [scripts/wiki_operational_pass.py]({script}); ejecute `--write` para actualizar y `--check` antes del PR.",
            "none": "-",
            "unknown": "desconocido",
            "ok": "ok",
            "missing_action": "falta la página de la acción",
            "signal_blocked_by_decision": "bloqueada por decisión",
            "signal_source_not_ingested": "fuente no ingerida",
            "signal_needs_review": "requiere revisión",
            "signal_ok": "ok",
            "vital_fresh": "vigente",
            "vital_stale": "desactualizado",
            "vital_missing": "hub ausente",
            "vital_unknown": "desconocido",
            "empty_contexts": "| No se encontraron contextos. | - | - | - | - | - | - | - | - |",
            "empty_outputs": "| No hay resultados de consolidación. | - | - | - | - | - | - | - |",
            "empty_sources": "| No hay fuentes registradas. | - | - | - | - | - | - |",
            "empty_actions": "| No hay acciones registradas. | - | - | - | - | - |",
            "empty_decisions": "| No se detectaron decisiones pendientes. | - | - | - | - | - |",
            "empty_decision_blocks": "| No hay acciones bloqueadas por decisiones pendientes. | - | - | - | - |",
            "empty_attention": "| No se detectaron problemas o incertidumbres mediante heurísticas. | - | - | - |",
            "h_operational_model": "## Modelo operativo por contexto",
            "role_label": "Rol",
            "role_health_label": "¿saludable?",
            "responsibility_label": "Responsabilidad",
            "responsibility_health_label": "¿al día?",
            "action_label": "Acción",
            "next_step_label": "Próximo paso",
            "trigger_label": "desencadenante",
            "assignment_label": "Asignación",
            "responsibility_no_action": "sin acción abierta (preventiva)",
            "roleless_context": "_(contextos sin un rol definido: {count})_",
            "empty_operational_model": "_(no hay roles definidos por contexto.)_",
            "health_ok": "ok",
            "health_atencao": "atención",
            "health_sem_acao": "sin acción",
            "health_sem_responsabilidade": "sin responsabilidad",
        },
        "pt": {
