...
5. Create an event in [memorias/sistema/ingestao/eventos/](../../memorias/sistema/ingestao/eventos/) using [docs/referencias/templates/wiki/ingestao-evento.md](../../docs/referencias/templates/wiki/ingestao-evento.md).
