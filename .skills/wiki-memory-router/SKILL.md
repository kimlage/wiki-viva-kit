...
description: Generic router for Markdown/Git living-wiki repos that use memorias/, docs/referencias/, wiki.config.yaml, wiki_core, PR gates, source manifests, normalized ingestion events, and operation cockpit pages.
---
...
2. Read [memorias/index.md](../../memorias/index.md).
3. Open [memorias/operacao.md](../../memorias/operacao.md) when it exists.
4. Select the context-specific local skill only after the root memory explains the context.
5. Treat [docs/referencias/](../../docs/referencias/) as references, templates and audit history, not as live memory.
