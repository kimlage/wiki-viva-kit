---
page_id: sistema-aprovacoes-git
...
- Standard: `wiki/ingest-YYYY-MM-DD-<tema>`.
- System adjustments: `wiki/system-<tema>`.
- Small fixes: `wiki/fix-<tema>`.
...
- `privacy-review`
- `system`
- `<contexto>` (one per context declared in the config)

## PR checklist

- [memorias/](../) contains actionable synthesis.
...
- No access secret, individualized secure link, or full dump without
  criteria was copied.
- [memorias/sistema/log.md](log.md) was updated.
