...
Deterministic, dry-run-first and PR-gated. It NEVER overwrites a value the owner
wrote and NEVER invents data — unknown values become explicit ``TODO``
placeholders for a human to complete. The only replacement it performs is the
safe promotion of an exact, untouched scaffold generated by this framework.
