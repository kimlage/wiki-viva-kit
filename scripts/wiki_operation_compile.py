...
COCKPIT_STRINGS: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "proposal_state": "- Estado no momento da compilacao: branch de proposta `wiki/*`; abrir ou verificar o PR antes de publicar ou concluir.",
    ...
    "en": {
        ...
        "proposal_state": "- Compile-time state: proposal branch `wiki/*`; open or check the PR before publishing or concluding.",
...
def _branch_state_line(branch: str, s: dict[str, str]) -> str:
    """Human-facing PR/state hint for the current branch."""
    if branch == "main":
