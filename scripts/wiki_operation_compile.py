...
COCKPIT_STRINGS: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "proposal_state": "- Branch de proposta `wiki/*`: abrir ou verificar o PR antes de publicar ou concluir.",
        "approved_state": "- Estado aprovado em `main`: criar uma branch `wiki/*` antes de propor nova mudanca.",
        "branch_state": "- Branch `{branch}`: verificar politica de PR antes de publicar ou concluir.",
    ...
    "en": {
        ...
        "proposal_state": "- Proposal branch `wiki/*`: open or check the PR before publishing or concluding.",
        "approved_state": "- Approved state on `main`: create a `wiki/*` branch before proposing a new change.",
        "branch_state": "- Branch `{branch}`: check PR policy before publishing or concluding.",
