---
page_id: system-journal-2026-06-09-wiki-construction
...
related_pages:
  ...
  - memories/system/perception/wiki-system-relationship-map.md
perception_policy:
  layer: perceptiva
...
- What exactly may be promoted: the learning "code that does not run in the flow
  ...
  [method coverage](../methodology-coverage-v5.md) and a derived insight.
...
- Relationship map: [wiki-system-relationship-map.md](wiki-system-relationship-map.md).
