...
Maintains the separation between consolidated memory ([memories/](../)) and
reference material ([docs/](../../docs/)).

## Rule

- [memories/](../) is the primary memory: actionable synthesis, decisions, rules, and context.
- [docs/references/](../../docs/references/) holds templates, snapshots, and reference
