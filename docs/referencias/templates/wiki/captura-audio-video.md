...
```yaml
---
page_id: template-captura-audio-video
...
related_pages:
  - docs/referencias/templates/wiki/source.md
...
- Artifact link: [media file](../../../../data/raw/) <!-- ou link do Drive -->
- Type: `audio` | `video`
- Duration:
- Captured on (date):
- Captured by:
...
- Transcript confidence level: `baixo` | `medio` | `alto`

## Related

- MOC: [index.md](../../../../memorias/index.md)
- Source: [source.md](source.md)
- Ingestion event: [ingestao-evento.md](ingestao-evento.md)
