...
stale_after_days: 30
page_id: action-region-pressure-045
page_type: action
title: Dense canonical action 045
context: clientes
...
# Dense canonical action 045

Canonical synthetic work object 045; it is not an executable operator command.
