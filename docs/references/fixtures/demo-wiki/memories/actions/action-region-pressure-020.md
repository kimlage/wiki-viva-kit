...
stale_after_days: 30
page_id: action-region-pressure-020
page_type: action
title: Dense canonical action 020
context: clientes
...
# Dense canonical action 020

Canonical synthetic work object 020; it is not an executable operator command.
