...
stale_after_days: 30
page_id: action-region-pressure-057
page_type: action
title: Dense canonical action 057
context: clientes
...
# Dense canonical action 057

Canonical synthetic work object 057; it is not an executable operator command.
