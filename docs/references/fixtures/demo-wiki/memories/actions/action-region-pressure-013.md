...
stale_after_days: 30
page_id: action-region-pressure-013
page_type: action
title: Dense canonical action 013
context: clientes
...
# Dense canonical action 013

Canonical synthetic work object 013; it is not an executable operator command.
