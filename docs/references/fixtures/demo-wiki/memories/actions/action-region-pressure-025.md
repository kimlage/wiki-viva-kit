...
stale_after_days: 30
page_id: action-region-pressure-025
page_type: action
title: Dense canonical action 025
context: clientes
...
# Dense canonical action 025

Canonical synthetic work object 025; it is not an executable operator command.
