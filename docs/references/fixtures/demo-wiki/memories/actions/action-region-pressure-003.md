...
stale_after_days: 30
page_id: action-region-pressure-003
page_type: action
title: Dense canonical action 003
context: clientes
...
# Dense canonical action 003

Canonical synthetic work object 003; it is not an executable operator command.
