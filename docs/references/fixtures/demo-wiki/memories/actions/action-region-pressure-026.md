...
stale_after_days: 30
page_id: action-region-pressure-026
page_type: action
title: Dense canonical action 026
context: clientes
...
# Dense canonical action 026

Canonical synthetic work object 026; it is not an executable operator command.
