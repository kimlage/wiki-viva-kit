...
stale_after_days: 30
page_id: action-region-pressure-031
page_type: action
title: Dense canonical action 031
context: clientes
...
# Dense canonical action 031

Canonical synthetic work object 031; it is not an executable operator command.
