...
stale_after_days: 30
page_id: action-region-pressure-033
page_type: action
title: Dense canonical action 033
context: clientes
...
# Dense canonical action 033

Canonical synthetic work object 033; it is not an executable operator command.
