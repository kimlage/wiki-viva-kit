...
stale_after_days: 30
page_id: action-region-pressure-015
page_type: action
title: Dense canonical action 015
context: clientes
...
# Dense canonical action 015

Canonical synthetic work object 015; it is not an executable operator command.
