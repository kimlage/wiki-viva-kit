...
stale_after_days: 30
page_id: action-region-pressure-050
page_type: action
title: Dense canonical action 050
context: clientes
...
# Dense canonical action 050

Canonical synthetic work object 050; it is not an executable operator command.
