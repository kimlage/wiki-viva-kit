...
stale_after_days: 30
page_id: action-region-pressure-014
page_type: action
title: Dense canonical action 014
context: clientes
...
# Dense canonical action 014

Canonical synthetic work object 014; it is not an executable operator command.
