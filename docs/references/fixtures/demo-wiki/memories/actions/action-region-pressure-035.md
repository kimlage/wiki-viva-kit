...
stale_after_days: 30
page_id: action-region-pressure-035
page_type: action
title: Dense canonical action 035
context: clientes
...
# Dense canonical action 035

Canonical synthetic work object 035; it is not an executable operator command.
