...
required two writes to reach a fixed point. Rc32 is pinned only for exact
...
artifact is regenerated, but the wholly new
validation/candidate/capture/certification sequence has not yet run.
...
#### Rc22 failed capture, rc23/rc25/rc27/rc31 failed validation, rc24/rc26 failed certification, rc28/rc29/rc30 rejected and rc32 validation pin — 2026-07-14
...
| Rc32 validation source | Source `ed073dee5fbf05343b36db1fdc061a24d0220cb9`; package `wiki-viva-v8-rc32` / `validation_pending`; package-file/canonical-package/tree `f88cb5fc625a28e2aff40518d895aa5668110838b2fd4179e53407f06ba2311d` / `8c07f05a680b1bd47994b3560067c28bcf5416aa2bc3546f1e698466940d2b81` / `7da9d6369550d45f368ee3ddb4f04382949f498fd0c2ff9350389243bd0fb82f`, 521 entries | Stale-target, missing-target, JSON, custom-output and relative-root fixed-point regressions pass; 198 focused operational/workflow/package/lane tests pass with `-W error`; one regeneration is immediately check-clean at dashboard SHA-256 `b632bf8e...` | Pinned only for exact validation. `package_is_pinned` remains false; no plan, import, browser, candidate, capture, capsule or public-promotion authority exists |
...
rejection and rc32 is pinned only for exact validation at
`ed073dee5fbf05343b36db1fdc061a24d0220cb9`. The
...
`ed073dee5fbf05343b36db1fdc061a24d0220cb9` and its separate
validation-only metadata boundary with the one-write operational-pass fixed
point, public synthetic stale/missing-target regressions, exact local/CI
warning policy and strict-browser dependency on deterministic audit success.
Run one complete exact validation, a separate
