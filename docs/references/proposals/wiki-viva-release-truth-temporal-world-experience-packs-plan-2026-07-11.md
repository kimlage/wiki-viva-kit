...
`7afa7ece276197c3e7dc746dfa35c17990687ed4` and is now a local-QA
`candidate`. No productive capture, visual manifest, capsule, attestation,
certification receipt or adoption authority exists yet.
...
| Exact public rc26 validated local-QA candidate | Exact source `da3a9a0495db974e409f5af6413401c31851e071` retains RT-156/RT-157 and closes RT-159 through RT-161; validation subject `7afa7ece276197c3e7dc746dfa35c17990687ed4`; validation-pending package-file/canonical-package/tree `f5e73c17...` / `2266b30d...` / `24d3f0f7...`; candidate package-file/canonical-package/tree `f2f384e5...` / `73cbca1b...` / `b27fbe27...`, both with 521 entries | Complete exact validation passed 1,728 Python with 3 declared skips and 2 warnings in 1,193.34 s, 516 frontend, 115 Node, the full static stack and first/only browser run `public-mrkxrlvb-620f3776-799d-4c2e-a748-ae6110e5000d` at 102/102, 0 skips/retries in 6.2m | Temporal values are valid without optional format plugins, day `00` and malformed values are rejected, target identity is canonical, portable documentation no longer depends on C3, and exact-subject browser proof is clean | Local-QA candidate only. Productive capture, visual manifest, certification, capsule verification, downstream QA and human/promotion gates remain pending; no rc25 result is reusable |
...
| Public demos | Seven executable base scenarios, nine Genesis stages and two pack showcases exist | Exact rc26 passed its first/only 102-cell public matrix with 0 skips/retries, including demo, pack, Genesis, accessibility, compatibility, failure and source-lifecycle cells | Gallery, source/failure/compatibility/accessibility worlds and pack Chronoscope are concrete | The rc26 browser proof is exact-subject validation evidence; productive capture, certification and human review remain separate |
| Visual system | Light/dark themes, three densities, semantic tokens, licensed asset manifest, WebGL and 2D fallback render | Exact rc26 passed 102 browser cells including PT-BR, keyboard, touch, mobile, fallback, runtime identity and RT-151/RT-155 regressions; its productive four-profile capture has not started | The validated native/fallback/profile behavior is exact-subject automation evidence; transition frames still require settling and VoiceOver remains human | Rc24 visual evidence is historical and cannot be reused. Rc26 still needs its own productive capture, certification and human conceptual/privacy/VoiceOver review |
...
for a separately certified exact rc26-or-later subject. Public closure never
...
| RT-150 | rc26 became `candidate` only after exact validation, but package pinning is still not capsule or adoption authority | run fresh productive capture and certification, independently verify the capsule, then require fresh private preflight and the separate human/promotion boundary |
...
stage started. All new certification must begin from a separately pinned and
fully validated rc26-or-later source. Public publication remains unauthorized.
...
entries. Productive capture, capsule and independent verification remain
pending. Public push and publication remain unauthorized.

#### Rc22 failed capture, rc23/rc25 failed validation, rc24 failed certification and rc26 boundary — 2026-07-14
...
| Rc26 validated candidate | Exact source `da3a9a0495db974e409f5af6413401c31851e071`; validation metadata `7afa7ece...`; validation-pending package-file/canonical-package/tree `f5e73c17...` / `2266b30d...` / `24d3f0f7...`; candidate package-file/canonical-package/tree `f2f384e5...` / `73cbca1b...` / `b27fbe27...`, 521 entries | 261 focused controls pass in 159.84 s; complete exact validation passes 1,728 Python with 3 skips/2 warnings in 1,193.34 s, 516 frontend, 115 Node and all static gates. First/only browser run `public-mrkxrlvb-620f3776-799d-4c2e-a748-ae6110e5000d` passes 102/102, 0 skips/retries in 6.2m; run/gate/report SHA-256 `e638a1f5...` / `59772cbd...` / `12c6e2a0...`. Productive capture, capsule and authority remain pending |
...
rc26-or-later authority exists. The rehearsal must use a fresh clone and branch
...
local-QA candidate. New productive capture, one certification and independent
capsule verification remain later separate stages. A later
...
Use the fresh rc26 source `da3a9a0495db974e409f5af6413401c31851e071`,
which retains RT-156/RT-157 and closes all three rc25 failures. Its exact
deterministic/browser validation passed at `7afa7ece...`, and this separately
reviewed metadata boundary makes it a local-QA candidate with candidate
package-file/canonical-package/tree identities `f2f384e5...` / `73cbca1b...` /
`b27fbe27...`, 521 entries. Run one new productive capture, single
certification and independent capsule verifier. Rc26 remains
local and non-promotional until downstream QA, remote CI, human review, merge and a
