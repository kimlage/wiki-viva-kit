...
`6fa9b907d5dfc748e94d182ac3704b226142552e` is pinned only for validation as
`wiki-viva-v8-rc31` / `validation_pending`. It adds a public synthetic
four-quadrant regression and quadrant-qualified group labels without changing
IDs, counts, family targets or drill lenses. A wholly new validation,
candidate, productive capture and certification sequence remains mandatory.
...
| Public rc31 validation source | Exact source `6fa9b907d5dfc748e94d182ac3704b226142552e`; package `wiki-viva-v8-rc31` / `validation_pending`; package-file/canonical-package/tree `f87ff28b...` / `3b6df79c...` / `f0322662...`, 521 entries | Public synthetic regression proves four same-family root projections receive unique `Q1`–`Q4` labels and malformed region IDs do not fabricate a quadrant; 517 frontend checks, architecture, assets and Node gates pass; disposable real-data downstream QA confirms lens-preserving navigation | RT-164 closes presentation and accessible-name ambiguity without changing IDs, counts, semantic target or facet-specific drill | Validation only. Run one new complete exact validation, then form a separate candidate, productive capture and certification from zero; public push/publication remains unauthorized |
...
| Public demos | Seven executable base scenarios, nine Genesis stages and two pack showcases exist | Exact rc26 passed its first/only 102-cell public matrix with 0 skips/retries, including demo, pack, Genesis, accessibility, compatibility, failure and source-lifecycle cells; rc27 stopped in Python before browser, rc28/rc29 were rejected pre-validation and rc30 was rejected before its complete matrix | Gallery, source/failure/compatibility/accessibility worlds and pack Chronoscope are concrete | Prior browser/capture proof remains exact-subject historical evidence only; rc31 must repeat every stage |
| Visual system | Light/dark themes, three densities, semantic tokens, licensed asset manifest, WebGL and 2D fallback render | Exact rc26 passed 102 browser cells and its first productive four-profile capture, manifest `6681e1f751ecd157854a4c3d78360a79f981100a4eda97ec377189ea9566614f`; rc27 never reached capture, rc28/rc29 were rejected pre-validation and rc30 stopped before its matrix on RT-164 | Native/fallback/profile behavior was captured without granting release authority; transition frames still require settling and VoiceOver remains human | Rc24 and rc26 visual evidence is historical and cannot be reused. Rc31 requires a fresh productive capture, certification and human conceptual/privacy/VoiceOver review |
...
for a separately certified exact rc31-or-later subject. Public closure never
...
separately pinned and fully validated rc31-or-later source. Public
...
#### Rc22 failed capture, rc23/rc25/rc27 failed validation, rc24/rc26 failed certification, rc28/rc29/rc30 rejected and rc31 boundary — 2026-07-14
...
| Rc31 exact validation source | Source `6fa9b907d5dfc748e94d182ac3704b226142552e`; package `wiki-viva-v8-rc31` / `validation_pending`; package-file/canonical-package/tree `f87ff28b4dd4c43b9c831dc7449888b16898de3a65dc1bafcb408aff80c7074c` / `3b6df79c764c2c287e26d15c50f74fde3fef12dc1f4ca03fffa48517c84751d4` / `f03226622e7be9e2668d4d39b8c642bf0a7b52571cbedada70071e656b461037`, 521 entries | Public four-quadrant fixture and malformed-ID negative pass in the 517-test cockpit suite; architecture, assets, Node gates and disposable downstream QA are green | Validation-only identity. Run one wholly new complete validation, then a separate candidate, productive capture and certification. No public push/publication authority |

Rc27 is frozen as historical failed-validation evidence, rc28/rc29 are frozen
as pre-validation rejections, rc30 is frozen as a pre-validation rejection and
rc31 is pinned only for exact validation. The
...
rc31-or-later authority exists. The rehearsal must use a fresh clone and branch
...
import it. Continue exact rc31 source
`6fa9b907d5dfc748e94d182ac3704b226142552e`, pinned only for validation with
the public four-quadrant label regression. Run one complete exact validation, a
separate candidate boundary, one new productive capture, one certification and
independent capsule verification from zero. Keep rc31 local and
