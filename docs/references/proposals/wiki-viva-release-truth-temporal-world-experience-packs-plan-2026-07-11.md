...
for a separately certified exact rc23-or-later subject. Public closure never
...
RT-153 negative evidence. All new certification starts from a new rc23
subject, and public publication remains unauthorized.
...
relabel, promote, import or use it as Lane B authority. Rc23 carries the public
synthetic route correction prospectively and remains unpinned until a later
metadata-only boundary. Public push and publication remain unauthorized.

#### Rc22 failed-capture checkpoint and rc23 boundary — 2026-07-14
...
| Portable tree | Validation-pending pair `20a92e19...` / `7e70e7b3...`; attempted candidate pair `d7a6a005...` / `e27f8efd...`; both reproduce 521 entries | The prior prose mixed package-bound tree digests; neither pair is receipt authority; derive rc23 only through exact `certify`/`verify-capsule` |
...
Start certification from a fresh rc23 subject that inherits no prior status,
receipt, manifest or digest claim. Rc23 stays local and non-promotional until
