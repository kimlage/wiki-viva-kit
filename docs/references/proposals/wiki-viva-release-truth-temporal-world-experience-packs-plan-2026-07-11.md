...
now binds exact public-safe source
`bc44255b22d65b8c9869ec45759afd4dac1355b9` and is pinned only for exact
validation as `wiki-viva-v8-rc30` / `validation_pending`. The one complete
validation, candidate, productive capture and certification sequence has not
started at this boundary. Public push and publication remain unauthorized.
...
| Public rc30 validation source | Exact source `bc44255b22d65b8c9869ec45759afd4dac1355b9`; package `wiki-viva-v8-rc30` / `validation_pending`; package-file/canonical-package/tree `a99e04d9...` / `adf99371...` / `af505d83...`, 521 entries | Preserves RT-163, makes portable skill/guides state-stable and replaces private-lineage fixture labels with neutral public synthetic data; cleanup-specific checks pass 27 Python with `-W error` and 516 frontend | Exact source/package/tree are pinned for the next first-attempt complete repository validation | Validation only. Run the complete exact validation once, then form a separate candidate, productive capture and certification sequence from zero; public push/publication remains unauthorized |
...
| Public demos | Seven executable base scenarios, nine Genesis stages and two pack showcases exist | Exact rc26 passed its first/only 102-cell public matrix with 0 skips/retries, including demo, pack, Genesis, accessibility, compatibility, failure and source-lifecycle cells; rc27 stopped in Python before browser and rc28/rc29 were rejected pre-validation | Gallery, source/failure/compatibility/accessibility worlds and pack Chronoscope are concrete | Rc26 browser/capture proof remains exact-subject historical evidence only; rc27/rc28/rc29 grant no browser or release authority, and rc30 must repeat every stage |
| Visual system | Light/dark themes, three densities, semantic tokens, licensed asset manifest, WebGL and 2D fallback render | Exact rc26 passed 102 browser cells and its first productive four-profile capture, manifest `6681e1f751ecd157854a4c3d78360a79f981100a4eda97ec377189ea9566614f`; rc27 never reached capture and rc28/rc29 were rejected pre-validation | Native/fallback/profile behavior was captured without granting release authority; transition frames still require settling and VoiceOver remains human | Rc24 and rc26 visual evidence is historical and cannot be reused. Rc30 requires a fresh productive capture, certification and human conceptual/privacy/VoiceOver review |
...
for a separately certified exact rc30-or-later subject. Public closure never
...
| RT-150 / RT-162 / RT-163 | rc26 became `candidate` only after exact validation, then passed productive capture and all six registered commands; the public-evidence scanner still rejected the transaction before attestation. Rc27 then stopped in its first `-W error` Python validation with 46 lifecycle failures before browser or candidate formation. Rc28 source `31cad3bc...` implemented the lifecycle corrections but was rejected for stale portable guides. Rc29 source `905e3772...` fixed those guides but was rejected for a stale portable skill and private-lineage fixture labels. Rc30 source `bc44255b...` preserves the fixes with state-stable, public-safe portable truth | Preserve rc26 as immutable failed-certification evidence, rc27 as immutable failed-validation evidence and rc28/rc29 as immutable pre-validation rejections. Rc30 is pinned only for exact validation; run that complete matrix once, then use separate candidate/capture/certification boundaries and independently verify its capsule before fresh private preflight or any promotion boundary |
...
candidate, capture and certification never started. All new certification must
begin from a separately pinned and fully validated rc30-or-later source. Public
...
`bc44255b22d65b8c9869ec45759afd4dac1355b9` is pinned only for validation as
`wiki-viva-v8-rc30` / `validation_pending`; complete validation and every later
authority stage remain pending. Public push and publication remain unauthorized.

#### Rc22 failed capture, rc23/rc25/rc27 failed validation, rc24/rc26 failed certification, rc28/rc29 rejected and rc30 boundary — 2026-07-14
...
| Rc30 exact validation source | Source `bc44255b22d65b8c9869ec45759afd4dac1355b9`; package `wiki-viva-v8-rc30` / `validation_pending`; package-file/canonical-package/tree `a99e04d9b41333778a5bee6fb405a85eb4050229ed354ea0151708b9b7f7323c` / `adf99371ab5e7ddc6b265cbc3dc73b9b7c66c18ca2c93c5c4db53836cf43083f` / `af505d83ff9ba2f73c8861c029234e3a844392e079f501cd36aa0ebd37a2da8b`, 521 entries | Preserves RT-163; makes portable skill/guides state-stable; replaces private-lineage fixtures with neutral public synthetic data. Cleanup-specific checks: 27 Python with `-W error`, 516 frontend, public audit 0 errors | Validation-only identity. Execute the one complete exact validation; only if green form a separate candidate boundary, new productive capture and certification from zero. No public push/publication authority |

Rc27 is frozen as historical failed-validation evidence, rc28/rc29 are frozen
as pre-validation rejections and rc30 is pinned only for exact validation. The
...
rc30-or-later authority exists. The rehearsal must use a fresh clone and branch
...
promote or import it. Continue exact rc30 source
`bc44255b22d65b8c9869ec45759afd4dac1355b9`, which preserves the
public-synthetic lifecycle fixes with state-stable portable truth and neutral
fixtures. Its package/tree identity is pinned only for validation. Run one
complete exact validation, a
separate candidate boundary, one new productive capture, one certification and
independent capsule verification from zero. Keep rc30 local and
