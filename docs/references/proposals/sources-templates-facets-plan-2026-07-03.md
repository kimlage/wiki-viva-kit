...
types:
  meeting:
    ...
    facets:                          # lens mapping (see 3.3); overrides defaults
      ...
      experiencia: [insights, journal_refs]
...
- **Experiência** — how it is lived/perceived: insights, journals, felt
...
- **No jargon at the surface** — Intenção/Experiência/Prática/Relações and
...
1. Facet wording in PT: **Intenção / Experiência / Prática / Relações** —
   good, or adjust (e.g. *Percepção* instead of *Experiência*)?
