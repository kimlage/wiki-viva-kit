...
const EN: Dict = {
  ...
  "perspective.quadrants.hint": "the AQAL home map: where everything lives (Intention/Practice/Relations/Systems)",
  "quadrant.core": "Core / Structure",
  "perspective.focus.needsPage": "Lock a page first, then Focus centers it through the four lenses.",
  "scene.lock.focus": "Focus",
  "scene.lock.focusTitle": "Center this page through the four lenses (F)",
  ...
  "create.title": "Seed in the quadrant",
  "create.intro": "The page type is the seed. Pick one — it lands in its home quadrant and its template drives the mold you fill. Composing hands a create brief to Codex (scaffold → fill → draft PR); nothing is written until you approve.",
  "create.noTypes": "No template types are registered for this wiki yet.",
  "create.seedsInto": "Seeds into",
  "create.name": "Title",
  "create.namePlaceholder": "e.g. Authorize the Q3 budget",
  "create.moldFields": "Fields",
  "create.fieldPlaceholder": "Leave empty if you can't ground it honestly",
  "create.noFields": "This type declares no pinned fields — Codex fills the body from the template.",
  "create.seed": "Seed with Codex",
  "create.seedHere": "Seed here",
  "create.gateNote": "Codex scaffolds via scripts/wiki_new.py, fills only what you grounded, and opens a draft PR. A human owns the gate.",
...
const PT: Dict = {
  ...
  "scene.lock.focus": "Foco",
  "scene.lock.focusTitle": "Centralizar esta página nas quatro lentes (F)",
  ...
  "create.title": "Semear no quadrante",
  "create.intro": "O tipo da página é a semente. Escolha um — ele pousa no seu quadrante-lar e o template dele guia o molde que você preenche. Compor entrega um brief de criação ao Codex (scaffold → preencher → PR rascunho); nada é escrito até você aprovar.",
  "create.noTypes": "Nenhum tipo de template está registrado nesta wiki ainda.",
  "create.seedsInto": "Semeia em",
  "create.name": "Título",
  "create.namePlaceholder": "ex.: Autorizar o orçamento do Q3",
  "create.moldFields": "Campos",
  "create.fieldPlaceholder": "Deixe vazio se não puder embasar honestamente",
  "create.noFields": "Este tipo não declara campos fixos — o Codex preenche o corpo pelo template.",
  "create.seed": "Semear com Codex",
  "create.seedHere": "Semear aqui",
  "create.gateNote": "O Codex faz o scaffold via scripts/wiki_new.py, preenche só o que você embasou e abre um PR rascunho. O humano é o portão.",
